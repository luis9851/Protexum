...
import { Multa } from '../models/multas/multas';
     ...
     this.turnoa = res.turnos;
      ...
      for(let i = 0; i < this.turnoa.length; i ++){
        ...
        for(let m = 0; m < this.turnoa[i].Guardias.multas.length; m++){ 
          ...
          var idm1  =  this.turnoa[i].Guardias.multas[0]?._id;
          var idm2  =  this.turnoa[i].Guardias.multas[1]?._id;
          var idm3  =  this.turnoa[i].Guardias.multas[2]?._id;
          var idm4  =  this.turnoa[i].Guardias.multas[3]?._id;
          var idm5  =  this.turnoa[i].Guardias.multas[4]?._id;
          var idm6  =  this.turnoa[i].Guardias.multas[5]?._id;
          var idm7  =  this.turnoa[i].Guardias.multas[6]?._id;
          var idm8  =  this.turnoa[i].Guardias.multas[7]?._id;
          var idm9  =  this.turnoa[i].Guardias.multas[8]?._id;
          var idm10  =  this.turnoa[i].Guardias.multas[9]?._id;
         ...
         console.log(idm, 'id de multaas')
          ...
          Montoapagartotalm = Montoapagar1m + Montoapagar2m + Montoapagar3m +Montoapagar4m +Montoapagar5m + Montoapagar6m + Montoapagar7m + Montoapagar8m + Montoapagar9m + Montoapagar10m;  
           ...
           var fechadMM = moment(this.turnoa[i].Guardias.multas[m].updatedAt).format("D");
          console.log(fechadMM)
        ...
        if( this.hoy == 7  ){
            ...
            if(multaapagar != Montoapagartotalm ){
             ...
             this.servicioM.AgregartotalM(idGm, Montoapagartotalm).subscribe( (res)=> {
              ...
              console.log('emtre')
              this.servicioM.deletemulta(idm,idGm).subscribe( (res)=> {
                console.log(res)
              })
              Montoapagartotalm = 0
                if(Number(fechadMM) != this.hoy ){
                  this.servicioM.AgregartotalM(idGm, Montoapagartotalm).subscribe( (res)=> {
        ...
        if(this.turnoa[i].Guardias.multas.length == 0){
          Montoapagartotalm = 0;
          console.log(Montoapagartotal, 'no hay multas')
        }
