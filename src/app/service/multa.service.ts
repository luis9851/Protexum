  ...
  constructor(private http: HttpClient ) { 
   ...
   registrar( multa: Multa, Guardias:string ): Observable<Multa>{
    ...
    multa ).pipe(tap (
      ...
      return this.http.put<Multaid>(`${this.apiUrl}actualizarmontomulta/${id}`,
      ...
      (res: Multaid)=> {
       ...
       //eliminar clientes
  deletemulta(id: String, idG:String): Observable<Multaid>{
    return this.http.delete<Multaid>(`${this.apiUrl}deletemulta/${id}/${idG}`).pipe(tap(
      (res: Multaid)=> {
